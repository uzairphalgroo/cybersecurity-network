...
export interface SentinaraLogoProps {
...
export const SentinaraLogo: React.FC<SentinaraLogoProps> = ({
  size = 'md',
  showText = true,
  animated = true,
  className = '',
  ...
  const sizeMap = {
    ...
    hero: { icon: 'h-24 w-24 sm:h-28 sm:w-28 md:h-36 md:w-36', text: 'text-3xl sm:text-4xl md:text-5xl', sub: 'text-xs md:text-sm' },
  };
        ...
        <div className="flex flex-col">
          <div className="flex items-center gap-1.5">
            <span className={`font-black tracking-[0.2em] font-orbitron text-white ${currentSize.text} leading-none`}>
              SENTIN<span className="text-transparent bg-clip-text bg-gradient-to-r from-zinc-100 via-cyan-400 to-purple-400">ARA</span>
            </span>
...
export const AuditHoundLogo = SentinaraLogo;
